...
COMPANIES = [
    ...
    ("xAI (Colossus)", "Neocloud / AI-native", 55,
        {"Corporate bonds (public IG/HY)": 12, "Bank & syndicated loans": 18,
         "Alternate private credit": 20, "Insurance-linked lending": 3,
         "Securitization / ABS / CMBS": 2, "Convertibles / equity-linked": 0,
         "Vendor & equipment-lease financing": 15}, 45),
...
CAPEX = {
    ...
    "Neoclouds / AI-native (aggregate)": [60, 95, 110, 95, 90, 96],
}
...
DEALS = [
    ...
    ("xAI (Colossus)", "$10bn raise ($5bn secured notes/term loans + $5bn equity) via Morgan Stanley", "2025", "$10bn", "Loans + equity", "CNBC"),
    ("xAI (Colossus)", "Colossus 2 SPV (Valor Equity): ~$12.5bn debt + ~$7.5bn equity (NVIDIA up to $2bn) to buy & lease GPUs", "2025-26", "~$20bn", "SPV / vendor lease", "The Information; Yahoo"),
...
def build_cover(wb):
    ...
    blocks = [
        ...
        ("Scope & definitions", TEAL, [
            ...
            "• Neoclouds / AI-native infra: GPU-cloud & AI-native data-center builders (CoreWeave, xAI,",
            "   Nebius, IREN, Crusoe, Lambda, Fluidstack, Nscale, + an 'Other' aggregate).",
