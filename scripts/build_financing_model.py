...
GROUPS = [
    ...
    ("abs",     "5) SECURITIZATION / ABS / CMBS / SECURED DATA-CENTER BONDS", True),
...
DEBT_TXNS = [
    ...
    ("bonds", "o/s Jun'26", "CoreWeave (CRWV)", "Neocloud / AI-native", "144A bond investors", 2.0,
     "Senior unsecured HY bond", "9.25% cpn; YTW 8.6%; +444", "Jun 2030", "GCP; B1/B/BB-", "Seaport (6/12/26)"),
    ("bonds", "o/s Jun'26", "CoreWeave (CRWV)", "Neocloud / AI-native", "144A bond investors", 1.75,
     "Senior unsecured HY bond", "9.00% cpn; YTW 9.0%; +478", "Feb 2031", "GCP; B1/B/BB-", "Seaport (6/12/26)"),
    ("bonds", "o/s Jun'26", "CoreWeave (CRWV)", "Neocloud / AI-native", "144A bond investors", 2.75,
     "Senior unsecured HY bond", "9.75% cpn; YTW 9.3%; +507", "Oct 2031", "GCP; B1/B/BB-", "Seaport (6/12/26)"),
    ("bonds", "o/s Jun'26", "CoreWeave (CRWV)", "Neocloud / AI-native", "144A bond investors", 1.25,
     "Senior unsecured HY bond", "9.625% cpn; YTW 9.5%; +531", "Jul 2032", "GCP; B1/B/BB-", "Seaport (6/12/26)"),
    ...
    ("pc", "Oct 2025", "Meta — Hyperion (Beignet Investor LLC, RPLDCI)", "Hyperscaler",
     "PIMCO (~$18bn), BlackRock, Apollo; Blue Owl equity", 27.294,
     "Off-B/S SPV; 144A senior secured bond", "6.581%; YTW 6.4%; +193", "May 2049",
     "2.1GW Richland Parish LA; Meta lease + residual-value guarantee; A+ (S&P)", "IFR; FT; Seaport"),
    ...
    ("pc", "o/s Jun'26", "Oracle — Michigan (RD Michigan Property Owner I)", "Hyperscaler",
     "Blackstone (90%) / Related Digital (10%)", 14.0, "1st-lien secured DC bond / SPV",
     "7.50%; YTW 7.5%; +301", "Mar 2045", "974MW Saline MI; Oracle 17.5y lease (guarantee); Baa3/BBB",
     "Seaport (6/13/26); FT"),
    ...
    # --- 5) securitization / ABS / CMBS / secured data-center bonds ---
    ...
    # secured data-center project bonds (Seaport Global desk note, 12-13 Jun 2026) — HY tenant
    ("abs", "o/s Jun'26", "APLD ComputeCo (APLD) — Ellendale ND", "Colocation / data-center REIT", "144A bond investors", 2.35,
     "Secured DC bond", "9.25%; YTW 6.6%; +254", "Dec 2030", "Tenant CoreWeave (HY), 15y lease; 100/150MW Polaris Forge 1; BB-/BB-", "Seaport (Applied Digital)"),
    ("abs", "o/s Jun'26", "APLD ComputeCo 3 (ELNFOR) — Ellendale ND", "Colocation / data-center REIT", "144A bond investors", 1.59,
     "Secured 1st-lien DC bond", "7.00%; YTW 7.0%; +282", "Jun 2031", "Tenant CoreWeave (HY), 15y lease; 150MW (ELN-4); BB-/BB-", "Seaport (Applied Digital)"),
    ("abs", "o/s Jun'26", "Core Scientific Finance I (CORZ)", "Colocation / data-center REIT", "144A bond investors", 3.30,
     "Secured DC bond", "7.75%; YTW 7.3%; +307", "May 2031", "Tenant CoreWeave (HY), 12y lease; 6 facilities/5 sites; BB/BB-", "Seaport (Core Scientific)"),
    ("abs", "o/s Jun'26", "Edged Compute (EDGCOM) — Edged US", "Colocation / data-center REIT", "144A bond investors", 1.30,
     "Secured DC bond", "7.50%; YTW 7.9%; +369", "Apr 2031", "Tenants CoreWeave (Chicago 72MW) & Alibaba (Atlanta 42MW); BB+/BB-", "Seaport (Edged US)"),
    ("abs", "o/s Jun'26", "Elk Grove Village (ELKGVP) — Prime Data Centers", "Colocation / data-center REIT", "144A bond investors", 0.90,
     "Secured DC bond", "7.50%; YTW 7.2%; +303", "Jun 2031", "Tenant CoreWeave (HY), 15y lease; 72MW ORD01-01 IL; Ba3/(P)BB-/BB-", "Seaport (Prime Data Centers)"),
    ("abs", "o/s Jun'26", "SE Cosmos (SECMOS) — SB Energy/SoftBank", "Colocation / data-center REIT", "144A bond investors", 0.999,
     "Secured 1st-lien DC bond", "8.875%; YTW 7.8%; +356", "May 2031", "Tenant SoftBank, 15y lease; 50MW Austin TX; (P)BB+/BB-", "Seaport (SB Energy)"),
    # secured data-center project bonds — IG tenant
    ("abs", "o/s Jun'26", "APLD ComputeCo 2 (PFORGE) — Harwood ND", "Colocation / data-center REIT", "144A bond investors", 2.15,
     "Secured 1st-lien DC bond", "6.75%; YTW 6.6%; +244", "Mar 2031", "Tenant Oracle (IG, guarantee), 15y lease; 150/50MW Polaris Forge 2; Ba3/BB-", "Seaport (Applied Digital)"),
    ("abs", "o/s Jun'26", "Black Pearl Compute (BLKPRL) — Cipher Digital", "Colocation / data-center REIT", "144A bond investors", 2.0,
     "Secured DC bond", "6.125%; YTW 5.8%; +158", "Feb 2031", "Tenant AWS (IG, guarantee), 15y lease; 300MW TX; Ba2/BB-", "Seaport (Cipher)"),
    ("abs", "o/s Jun'26", "Cipher Compute (CIFR) — Cipher Digital", "Colocation / data-center REIT", "144A bond investors", 1.733,
     "Secured 1st-lien DC bond", "7.125%; YTW 6.0%; +184", "Nov 2030", "Tenant Fluidstack (Google backstop), 10y lease; 300MW Barber Lake TX; Ba3/BB-", "Seaport (Cipher)"),
    ("abs", "o/s Jun'26", "Flash Compute (FLASHC) — Terawulf/Fluidstack JV", "Colocation / data-center REIT", "144A bond investors", 1.30,
     "Secured DC bond", "7.25%; YTW 6.3%; +213", "Dec 2030", "Tenant Fluidstack (Google backstop), 10y lease; 240MW Abernathy TX; Ba3", "Seaport (Terawulf/Fluidstack)"),
    ("abs", "o/s Jun'26", "Meridian Arc Holdco (MERIDI) — Next Frontier/Fluidstack JV", "Colocation / data-center REIT", "144A bond investors", 5.70,
     "Secured DC bond", "6.25%; YTW 6.3%; +207", "Apr 2031", "Tenant Fluidstack (Google backstop), 15y lease; 245+185MW Sullivan Co. IN; Ba2/BB", "Seaport (Meridian Compute)"),
    ("abs", "o/s Jun'26", "PR RNO Property Owner 1 (TRACTD) — Tract Capital", "Colocation / data-center REIT", "144A bond investors", 4.585,
     "Secured DC bond", "6.50%; YTW 6.6%; +236", "May 2031", "Tenant Nvidia (IG), 16y lease; 200MW Storey Co. NV; Ba1/(P)BB/BB", "Seaport (Tract Capital)"),
    ("abs", "o/s Jun'26", "Stingray Compute (STNGRY) — Cipher Digital", "Colocation / data-center REIT", "144A bond investors", 0.81,
     "Secured DC bond", "6.00%; YTW 6.0%; +175", "Jun 2031", "Tenant AWS (IG), lease; 70MW Andrew TX; Ba2/BB-", "Seaport (Cipher)"),
    ("abs", "o/s Jun'26", "SV RNO Property Owner 1 (TRACTC) — Tract Capital", "Colocation / data-center REIT", "144A bond investors", 3.80,
     "Secured DC bond", "5.875%; YTW 6.3%; +206", "Mar 2031", "Tenant Nvidia (IG), 16y lease; 200MW Storey Co. NV; Ba1/(P)BB+/BB", "Seaport (Tract Capital)"),
    ("abs", "o/s Jun'26", "WULF Compute (WULF) — Terawulf", "Colocation / data-center REIT", "144A bond investors", 3.20,
     "Secured DC bond", "7.75%; YTW 6.0%; +189", "Oct 2030", "Tenant Fluidstack (Google backstop), 10y lease; 366MW Lake Mariner NY; Ba2/BB/BB", "Seaport (Terawulf)"),
    # secured data-center project bonds — investment grade
    ("abs", "o/s Jun'26", "Beacon Point DC (HUTBPA) — Hut 8", "Colocation / data-center REIT", "144A bond investors", 4.25,
     "Secured 1st-lien DC bond (IG)", "6.129%; YTW 6.0%; +155", "Nov 2042", "Tenant Nvidia (IG), 15y lease; 352MW Nueces Co. TX; Baa2", "Seaport (Hut 8)"),
    ("abs", "o/s Jun'26", "HUT 8 DC (HUTRBA) — River Bend", "Colocation / data-center REIT", "144A bond investors", 3.25,
     "Secured 1st-lien DC bond (IG)", "6.192%; YTW 6.0%; +154", "Nov 2042", "Tenant Fluidstack (Google backstop), 15y lease; 245MW St. Francisville LA; (P)BBB-/BBB-", "Seaport (Hut 8)"),
    ("abs", "o/s Jun'26", "QTS Fayetteville I (QTSQST) — QTS/Blackstone", "Colocation / data-center REIT", "144A bond investors", 4.60,
     "Secured DC bond (IG)", "5.70%; YTW 6.2%; +171", "Apr 2036", "Tenant Microsoft (IG), 20y lease; Atlanta GA; Baa2", "Seaport (QTS)"),
...
def build_deals_combined(wb):
    ...
    sources = [
        ...
        "Seaport Global (Andrew Cueter) — 'AI Data Centers (HY & IG)' desk note, 12-13 Jun 2026: secured",
        "  data-center bonds by tenant-credit tier (price/YTW/spread); Bloomberg, rating agencies, filings.",
