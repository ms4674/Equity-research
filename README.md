...
- **Post-training RL**: Detailed breakdown of reinforcement learning techniques (RLHF, DPO, GRPO, PPO, Rejection Sampling) with quantification of training compute and data scale
- **Benchmarks**: MMLU, MATH-500, HumanEval, and other key metrics
